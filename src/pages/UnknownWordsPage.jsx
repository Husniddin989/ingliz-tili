        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={'px-4 py-2 rounded-lg transition-colors ' + (viewMode === 'flashcard' ? 'bg-indigo-600 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600')}
            >
              📇 Flashcard
            </button>
            <button
              onClick={() => setViewMode('list')}
              className={'px-4 py-2 rounded-lg transition-colors ' + (viewMode === 'list' ? 'bg-indigo-600 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600')}
            >
              📋 Ro'yxat
            </button>
          </div>
