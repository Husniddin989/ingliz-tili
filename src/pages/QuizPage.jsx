...
const QuizPage = () => {
  ...
  const [quizMode, setQuizMode] = useState('en-uz');
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-md">
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  ...
                  className={'p-4 rounded-lg border-2 transition-all ' + (quizType === 'multiple' ? 'border-indigo-600 bg-indigo-50 dark:bg-indigo-900' : 'border-gray-300 dark:border-gray-600 hover:border-gray-400')}
                >
                ...
                <button
                  ...
                  className={'p-4 rounded-lg border-2 transition-all ' + (quizType === 'typing' ? 'border-indigo-600 bg-indigo-50 dark:bg-indigo-900' : 'border-gray-300 dark:border-gray-600 hover:border-gray-400')}
                >
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  onClick={() => setQuizMode('en-uz')}
                  className={'p-4 rounded-lg border-2 transition-all ' + (quizMode === 'en-uz' ? 'border-indigo-600 bg-indigo-50 dark:bg-indigo-900' : 'border-gray-300 dark:border-gray-600 hover:border-gray-400')}
                >
                  <div className="font-bold text-gray-800 dark:text-gray-100 mb-1">🇬🇧 → 🇺🇿</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">Ingliz savol, O'zbek javob</div>
                </button>
                <button
                  onClick={() => setQuizMode('uz-en')}
                  className={'p-4 rounded-lg border-2 transition-all ' + (quizMode === 'uz-en' ? 'border-indigo-600 bg-indigo-50 dark:bg-indigo-900' : 'border-gray-300 dark:border-gray-600 hover:border-gray-400')}
                >
                  <div className="font-bold text-gray-800 dark:text-gray-100 mb-1">🇺🇿 → 🇬🇧</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">O'zbek savol, Ingliz javob</div>
                </button>
              </div>
            </div>
  ...
  if (quizState === 'quiz') {
    ...
    const categoryLabel = { level1: 'Daraja 1', level2: 'Daraja 2', level3: 'Daraja 3', level4: 'Daraja 4' };
              ...
              <div className="space-y-3">
                {currentQuestion.options.map((option, index) => (
                  <button
                    ...
                    className={'w-full p-4 rounded-lg border-2 text-left transition-all ' + (selectedAnswer === option ? 'border-indigo-600 bg-indigo-50 dark:bg-indigo-900' : 'border-gray-300 dark:border-gray-600 hover:border-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700')}
                  >
                    <div className="flex items-center gap-3">
                      <div className={'w-6 h-6 rounded-full border-2 flex items-center justify-center ' + (selectedAnswer === option ? 'border-indigo-600 bg-indigo-600' : 'border-gray-400 dark:border-gray-500')}>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md">
          ...
          <div className="space-y-4">
            {results.results.map((result, index) => (
              <div
                key={index}
                className={'p-4 rounded-lg border-2 ' + (result.isCorrect ? 'border-green-300 bg-green-50 dark:bg-green-900 dark:border-green-700' : 'border-red-300 bg-red-50 dark:bg-red-900 dark:border-red-700')}
              >
